...
.PHONY: image
image:  ## Build mvc-demo image
	@build/image.sh

.PHONY: clean-image
clean-image:  ## Clean mvc-demo image
	@build/clean-image.sh

.PHONY: install
install:  ## Install mvc-demo with poetry
	@build/install.sh

.PHONY: metrics
metrics: install ## Run mvc-demo metrics checks
	@build/metrics.sh

.PHONY: unit-test
unit-test: install ## Run mvc-demo unit tests
	@build/unit-test.sh

.PHONY: integration-test
integration-test: install ## Run mvc-demo integration tests
